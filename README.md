About pysw4-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysw4-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/shaharkadmiel/pySW4/

Documentation: http://shaharkadmiel.github.io/pySW4/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3255&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysw4-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysw4` can be installed with `conda`:
...
It is possible to list all of the versions of `pysw4` available on your platform with `conda`:
...
```
mamba search pysw4 --channel conda-forge
```
...
mamba repoquery search pysw4 --channel conda-forge

# List packages depending on `pysw4`:
mamba repoquery whoneeds pysw4 --channel conda-forge

# List dependencies of `pysw4`:
mamba repoquery depends pysw4 --channel conda-forge
```
